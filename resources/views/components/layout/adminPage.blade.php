    ...
    <script>
        async function fetchUser() {
            try {
                ...
                if (namaUserDisplay) namaUserDisplay.textContent = data.data.nama_lengkap;

                const namaUserDisplay1 = document.getElementById('namaUserDisplay1');
                if (namaUserDisplay1) namaUserDisplay1.textContent = data.data.nama_lengkap;

                const namaUserDisplay2 = document.getElementById('namaUserDisplay2');
                if (namaUserDisplay2) namaUserDisplay2.textContent = data.data.nama_lengkap;

                const roleUserDisplay = document.getElementById('roleUserDisplay');
                if (roleUserDisplay) roleUserDisplay.textContent = data.data.role;
