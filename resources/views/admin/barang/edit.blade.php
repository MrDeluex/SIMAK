    ...
    <form action="" class="w-full" id="editForm">
        <div class="w-full p-10 flex flex-col justify-start items-start gap-8"
            ...
            <div class="w-full flex justify-between items-center">
                <button type="button" class="px-10 py-1 rounded bg-button-false text-white" onclick="window.location.href='/admin/barang'">Kembali</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", async function() {
            ...
            async function loadKategoriBarang(selectedId) {
                ...
                try {
                    const res = await fetch("https://backend-simak.trihech.my.id/api/admin/kategori/", {
                        headers: {
            ...
            form.addEventListener("submit", async function(event) {
                ...
                try {
                    const res = await fetch(`https://backend-simak.trihech.my.id/api/admin/barang/${id}`, {
                        method: "PUT",
                        headers: {
