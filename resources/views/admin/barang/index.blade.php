<x-layout.adminPage>
    ...
    <body>
                ...
                <table id="dataTable" class="min-w-full">
                    <thead class="bg-secondary-2 text-white">
                        <tr>
                            ...
                            <th style="width: 25%;">Upah Barang</th>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const kategori_barangElement = document.getElementById("kategori_barang");
                    const kategori_barang = kategori_barangElement ? kategori_barangElement.value : "";
                    ...
                    const filteredData = data.data.filter(item =>
                        item.kategori_barang.toLowerCase().includes(search) &&
                        (kategori_barang === '' || item.kategori_barang === kategori_barang)
                    );
                    ...
                    if (kategori_barangElement) renderkategori_barangs(data, kategori_barang);
                } catch (error) {
            ...
            <div class="w-full flex justify-start items-center gap-3">
                <p class="w-auto">kategori_barang :</p>
        ...
        <tr>
            ...
            function renderkategori_barangs(data, selectedkategori_barang) {
                const kategori_barangSelect = document.getElementById("kategori_barang");
                kategori_barangSelect.innerHTML = '<option value="">All</option>' +
                    Array.from(new Set(data.map(item => item.kategori_barang)))
                    .map(kategori_barang => `<option value="${kategori_barang}" ${kategori_barang === selectedkategori_barang ? "selected" : ""}>${kategori_barang}</option>`)
                    .join("");
            }

            document.getElementById("kategori_barang")?.addEventListener("change", fetchData);
