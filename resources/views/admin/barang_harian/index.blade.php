    ...
    <body>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('https://backend-simak.trihech.my.id/api/admin/barang-harian', {
                        method: 'GET',
                        headers: {
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/admin/barang-harian/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`https://backend-simak.trihech.my.id/api/admin/barang-harian/${id}`, {
                        method: "GET",
                        headers: {
                            "Authorization": "Bearer " + '{{ session("api_token") }}'
                        }
                    ...
                    window.location.href = `/admin/harian/edit`;
                } catch (error) {
                    alert(error.message);
                }
            }
