<x-layout.administrasiPage>
    ...
    <body>
        ...
        <a href="/staffAdministrasi/harian/create">
            <button class="font-light w-68 py-1 bg-secondary-2 text-white rounded-xl mb-6">TAMBAH DATA HARIAN</button>
        </a>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('http://localhost:8080/api/staff-administrasi/barang-harian', {
                        method: 'GET',
                        headers: {
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`http://localhost:8080/api/staff-administrasi/barang-harian/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`http://localhost:8080/api/staff-administrasi/barang-harian/${id}`, {
                        method: "GET",
                        headers: {
                            "Authorization": "Bearer " + '{{ session("api_token") }}'
                        }
