    ...
    <body>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('https://backend-simak.trihech.my.id/api/staff-administrasi/kategori', {
                        method: 'GET',
                        headers: {
        ...
        `).join("");
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/kategori/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/kategori/${id}`, {
                        method: "GET",
                        headers: {
