    ...
    <body>
        ...
        <script>
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`http://backend-simak.trihech.my.id/api/staff-administrasi/staff-produksi/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`http://backend-simak.trihech.my.id/api/staff-administrasi/staff-produksi/${id}`, {
                        method: "GET",
                        headers: {
