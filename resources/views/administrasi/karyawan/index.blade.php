<x-layout.administrasiPage>
    ...
    <body>
        ...
        <a href="/staffAdministrasi/karyawan/create">
            <button class="font-light w-68 py-1 bg-button-true text-white rounded-xl mb-6">TAMBAH KARYAWAN</button>
        </a>
        ...
        <script>
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/staff-produksi/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/staff-produksi/${id}`, {
                        method: "GET",
                        headers: {
