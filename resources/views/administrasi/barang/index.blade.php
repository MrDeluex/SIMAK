    ...
    <body>
                ...
                <table id="dataTable" class="min-w-full">
                    <thead class="bg-custom-1 text-white">
                        <tr>
                            ...
                            <th style="width: 20%;" class="text-center sm:hidden">Stock</th>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('https://backend-simak.trihech.my.id/api/staff-administrasi/barang', {
                        method: 'GET',
                        headers: {
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/barang/${id}`, {
                        method: 'POST',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/barang/${id}`, {
                        method: "POST",
                        headers: {
                            "Authorization": "Bearer " + '{{ session("api_token") }}'
                        }
                    ...
                    window.location.href = `/staffAdministrasi/barang/edit`;
                } catch (error) {
                    alert(error.message);
                }
            }
            ...
            async function deleteItem(id) {
                ...
                if (!confirmDelete.isConfirmed) {
                    return; // Jika tidak dikonfirmasi, batalkan proses
                }
                ...
                try {
                    ...
                    Swal.fire({
                        ...
                        window.location.reload(); // Me-refresh halaman setelah pop-up ditutup
                    });
            ...
            async function tambahStock(id) {
                try {
                    ...
                    // Redirect ke halaman edit
                    window.location.href = `/staffAdministrasi/stock`;
                } catch (error) {
                    alert(error.message);
                }
            }
