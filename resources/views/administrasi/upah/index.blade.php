<x-layout.administrasiPage>
    ...
    <body>
        ...
        <a href="/staffAdministrasi/upah/create">
            <button class="font-light w-68 py-1 bg-button-true text-white rounded-xl mb-6">INPUT UPAH KARYAWAN</button>
        </a>
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('https://backend-simak.trihech.my.id/api/staff-administrasi/upah', {
                        method: 'GET',
                        headers: {
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/upah/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
        ...
        <script>
            async function editItem(id) {
                try {
                    let response = await fetch(`https://backend-simak.trihech.my.id/api/staff-administrasi/upah/${id}`, {
                        method: "GET",
                        headers: {
                            "Authorization": "Bearer " + '{{ session("api_token") }}'
                        }
                    ...
                    window.location.href = `/staffAdministrasi/upah/edit`;
                } catch (error) {
                    alert(error.message);
                }
            }
