<x-layout.userPage>
    ...
    <body>
        ...
        <a href="/staff-produksi/harian/create">
        ...
        <script>
            ...
            async function fetchData() {
                try {
                    ...
                    const response = await fetch('https://backend-simak.trihech.my.id/api/staff-produksi/barang-harian', {
                        method: 'GET',
                        headers: {
            ...
            async function viewDetail(id) {
                try {
                    const response = await fetch(`https://backend-simak.trihech.my.id/api/staff-produksi/barang-harian/${id}`, {
                        method: 'GET',
                        headers: {
                            'Authorization': 'Bearer ' + '{{ session("api_token") }}'
                        }
